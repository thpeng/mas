...
\begin{document}
    ...
    generates value by investing resources in an Internal Developer Portal.
    ...
    Overall, the seventeen questions have an mean score of 3.40, the average of negative responses (1.2) is 18.5\% of the
    respondents and the average of positive responses (4.5) is 51.3\%.\\
    Based on an industry standard 95\% confidence level\parencite{nistmean}, a population size of 76, a critical value
    of 1.96 and a standard deviation of 1.0155, the confidence interval is 3.40 \textpm 0.228.\\
    % low: 3.172, high: 3.628
    % calc \[ 0.228 = 1.96 * (1.0155 / \sqrt{76})]
    %see https://www.scribbr.com/statistics/confidence-interval/
    Respondents with scores of 1 and 2 are counted as Negative and respondents with 4 and 5 are counted as the Positive.\\
    The standard deviation for the rating questions ranges from 0.590 to 1.420.
    ...
    \begin{table}[!htbp]
        \begin{center}
            \begin{tabularx}{\textwidth}{llllll}
                \toprule
                Topic           & Ids       & Mean & Negative & Positive \\
                \midrule
                Discoverability & 1, 13, 14 & 3.11   & 24.4\%   & 35.1\%   \\
                Expertise       & 2         & 3.64   & 12.0\%   & 65.3\%   \\
                Documentation   & 3, 17     & 3.41   & 18.7\%   & 51.9\%   \\
                Golden Path     & 10        & 3.21   & 20.0\%   & 42.7\%   \\
                FinOps          & 12        & 2.62   & 45.3\%   & 21.3\%   \\
                \bottomrule
            \end{tabularx}
        \end{center}
    ...
    \begin{table}[!htbp]
        \begin{center}
            \begin{tabularx}{\textwidth}{llllll}
                ...
                Topic     & Ids           & Mean & Negative & Positive \\
                \midrule
                Lifecycle & 5, 6, 7, 8, 9 & 3.59   & 13.9\%   & 59.5\%   \\
                Platform  & 4, 11, 16     & 3.46   & 15.6\%   & 54.7\%   \\
                Incident  & 15            & 3.92   & 10.7\%   & 74.7\%   \\
                \bottomrule
            \end{tabularx}
        \end{center}
    ...
    Discoverability and Obtaining Information (3.11) and FinOps (2.62) are below the mean for all questions (3.40)
    and outside the margin of error (\textpm 0.228).\\
    The mean of the Documentation and Communication theme is 3.41, almost on par with the overall mean.
    ...
    \begin{itemize}
        \item Two of the five tested value propositions of an Internal Developer Portal are below the overall average and outside the error margin
    ...
    \end{itemize}
    The Golden Path topic might be also benefit from an Internal Developer Portal.
    ...
    \begin{table}[!htbp]
        \begin{center}
            \begin{tabularx}{\textwidth}{lllll}
                \toprule
                Id & Mean & Negative & Positive & Standard Deviation \\
                \midrule
                1  & 3.04   & 20.0\%   & 28.0\%   & 0.774              \\
                2  & 3.64   & 12.0\%   & 65.3\%   & 1.055              \\
                3  & 3.25   & 18.7\%   & 42.7\%   & 0.819              \\
                4  & 3.37   & 18.7\%   & 52.0\%   & 1.153              \\
                5  & 3.55   & 17.3\%   & 57.3\%   & 1.182              \\
                6  & 3.92   & 8.0\%    & 70.7\%   & 0.963              \\
                7  & 3.59   & 10.7\%   & 62.7\%   & 1.035              \\
                8  & 3.55   & 21.3\%   & 57.3\%   & 1.025              \\
                9  & 3.32   & 20.0\%   & 49.3\%   & 1.169              \\
                10 & 3.21   & 20.0\%   & 42.7\%   & 0.929              \\
                11 & 3.76   & 8.0\%    & 66.7\%   & 0.936              \\
                12 & 2.62   & 45.3\%   & 21.3\%   & 1.200              \\
                13 & 3.38   & 16.0\%   & 44.0\%   & 0.923              \\
                14 & 2.92   & 37.3\%   & 33.3\%   & 1.030              \\
                15 & 3.92   & 10.7\%   & 74.7\%   & 1.055              \\
                16 & 3.25   & 20.0\%   & 45.3\%   & 0.954              \\
                17 & 3.53   & 18.7\%   & 58.7\%   & 1.064              \\
                \bottomrule
            \end{tabularx}
        \end{center}
