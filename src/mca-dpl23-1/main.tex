...
\begin{document}
    ...
    \begin{table}[!htbp]
        \begin{center}
            ...
            \end{tabularx}
        \end{center}
        \caption{\label{tab:aggregateidpresults} Rating questions raw result from the survey.}
    \end{table}
    ...
    \begin{table}[!htbp]
        \begin{center}
            ...
            \end{tabularx}
        \end{center}
        \caption{\label{tab:nonidpresults} Rating questions raw result from the survey.}
    \end{table}
