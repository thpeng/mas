...
\begin{document}
    ...
    Therefore, one could argue that the concept of an Internal Developer Platform isn't unique to certain products or
    ...
    One challenge is that it's usually not transparent within the company which engineer possesses what kind of specialty
    know-how.
    ...
    She needs to find the team which is responsible for a given platform and needs to know how she can contact them.\\
    ...
    Based on the data from the evaluation questions in chapter \ref{sssec:rratque}, the topic of FinOps is significant
    below the mean (3.40) of the survey.
    ...
    Lifecycle of Resources has an average score of 3.59 and considering the confidence interval is above the overall mean of the survey.
    ...
    \end{itemize}
    For the topics Golden Path and Documentation and Communication, the picture is less clear.
    Both have an overlap of their confidence interval with the overall mean of the survey.
    The topic Golden Path rated higher than the Documentation and Communication, but interestingly the Documentation and
    ...
    until it is fixed again and in working order.} or an improved future net promoter score.\\
