...
\begin{document}
    ...
    There are multiple issues with the older, but still supported, CI/CD pipeline.
    ...
    Three had some suggestions about adding tools and improving the development toolset and
    one said about the setup process: ``In 15 Minuten Entwicklungsumgebung aufsetzen und los coden ist schon geil! :-)``
    Three respondents simply stated their gratitude and thanked various service and platform teams for their effort.
    One respondent simply wrote ``danke, von Herz``.
    Two mentions the topic of FinOps.
    One quote about this topic ``Kosten sind sehr schwierig zu verstehen und nachvollziehen auf die Rechnung. Reporting
