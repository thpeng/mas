...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item The lowest rated issue was related to the financial transparency around platform and resource usage (FinOps)
    ...
    can generate value by investing resources in an Internal Developer Portal and thus improving the DevOps experience and
    lowering the cognitive load of the engineers.
