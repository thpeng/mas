...
\begin{document}
    ...
    speed in responding to change.
    Four years later, a reorganization brought a new operating model to SBB IT based on agile principles, DevOps and
    ...
    \label{sssec:ropque}
    32 of the 76 respondents choose to fill out the open question.
    Six of the respondents mentioned the topic of Technical Documentation and Communication.
    Some notable quotes are: %TODO
    Four people mentioned the CI/CD pipelines.
    A quote from one of this respondents is as following %TODO
    Three respondents had some suggestions about improvement of the local installation of development tools, which was
    a target of the question 4.
    One suggestion was as following%TODO
    Three respondents simply stated their gratitude and thanked various service and platform teams for their effort.
    Two mentions the topic of FinOps with a quote %TODO
    There were also two suggestions about missing infrastructure as code capabilities with the input of
    Two feedback concerned the current vision of the so called Core DSRVs with %TODO
    Two questioned a perceived lack of consultancy and unified support with %TODO
    And finally, there were two critical votes about the modernization effort of the SBB IT which is known as the ''Gandalf Plan''.
    Six feedbacks each concerned various other topics which will not be discussed in more detail.
    ...
    \label{sssec:rengque}
    The average of the engagement question was 7.70 with a variance of xx\%.
    ...
    The topic Expertise has a rating of 3.64, which exceeds the average value.
    The topics which are not directly related to the Internal Developer Portal are at the average or above.
    Platform topics have an average of 3.46 is near the overall average.
    Lifecycle has an average value of 3.59 and the topic of Incident support is at an average of 3.92.
    Summarizing the data;
    \begin{itemize}
        \item Three of the five tested value propositions are below the overall average
        \item Two of the three other topics are above and one is near the overall average
        \item Fifteen answers for the open question contain issues or enhancement concerning one or more of the value propositions for the Internal Developer Portal
    \end{itemize}
