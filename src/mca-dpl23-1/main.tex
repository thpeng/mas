...
\begin{document}
    ...
    In addition, there is a sizable department, which is providing the tooling and platforms for creating and maintaining
    these applications.
    ...
    service, databases, messaging but also networking, security and
    ...
    In 2015 DevOps and a P was first introduced in the SBB IT .
