...
\begin{document}
    ...
    Other software is specially built for the mission-critical day-to-day operations of the railway such as the Rail Control System (RCS)\cite{sbbrcs}.
    ...
    \subsubsection{Internal Developer Platform}
    According to the core component definition of an Internal Developer Portal\cite{humanitec} the SBB IT has at least
    one or more existing solutions for each concern.
    \begin{itemize}
