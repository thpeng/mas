...
\begin{document}
    ...
    Four years later, a reorganisation brought a new operating model to the SBB IT, based on agile principles and SAFe
    and created the role of the BizDevOps engineer\parencite{sbbagile}.
    Most legacy roles such as an application engineer, an operations manager, test engineer or a requirements engineer
    were converted to this BizDevOps Engineer.
    Even some former business oriented roles are now called BizDevOps engineers.
    Now, there are DevOps teams established, but they are working mostly with tools from the organisation before.
    ...
    Rather it is the expectation, that a BizDevOps engineer gathers the information that he needs, over several tools and
