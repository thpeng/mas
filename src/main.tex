...
\begin{document}
    ...
    Cloud Platform (``TODO category``)and has no opinion about architectural style, such as the products mentioned in
    the category ``Microservice Catalog``.
    \begin{center}
    ...
    the currently promoted techstack and other internal specifics.
    ...
    \label{sec:sbbit}
    The IT departement of the Swiss Federal Railways (SBB) consists of around 1300 specialists and is responsible for
